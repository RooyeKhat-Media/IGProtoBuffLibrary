...
final public class IGPClientSearchUsername : GeneratedMessage {
    ...
    public fileprivate(set) var igpQuery:String = ""
    ...
    final public class IGPResult : GeneratedMessage {
        ...
        //iGap Properties declaration end
            ...
            public enum IGPType:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
                ...
                public static func fromString(str:String) throws -> IGPClientSearchUsernameResponse.IGPResult.IGPType {
                    switch str {
                    case "USER":    return .user
                    case "ROOM":    return .room
        ...
        public fileprivate(set) var igpExactMatch:Bool = false
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            public func clearIgpExactMatch() -> IGPClientSearchUsernameResponse.IGPResult.Builder{
                ...
                builderResult.igpExactMatch = false
                return self
            }
            ...
            class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPClientSearchUsernameResponse.IGPResult.Builder {
                ...
                if let jsonValueIgpType = jsonMap["IGPType"] as? String {
                    resultDecodedBuilder.igpType = try IGPClientSearchUsernameResponse.IGPResult.IGPType.fromString(str: jsonValueIgpType)
                }
