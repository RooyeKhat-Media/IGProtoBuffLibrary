...
/// Source file "ChatSendMessage.proto"
/// Syntax "Proto3"
...
public struct ChatSendMessageRoot {
    public static let `default` = ChatSendMessageRoot()
...
final public class IGPChatSendMessage : GeneratedMessage {
    public typealias BuilderType = IGPChatSendMessage.Builder

    public static func == (lhs: IGPChatSendMessage, rhs: IGPChatSendMessage) -> Bool {
        if lhs === rhs {
            return true
        }
    ...
    public class func getBuilder() -> IGPChatSendMessage.Builder {
        return IGPChatSendMessage.classBuilder() as! IGPChatSendMessage.Builder
    }
    public func getBuilder() -> IGPChatSendMessage.Builder {
        return classBuilder() as! IGPChatSendMessage.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
        return IGPChatSendMessage.Builder()
    }
    override public func classBuilder() -> ProtocolBuffersMessageBuilder {
        return IGPChatSendMessage.Builder()
    }
    public func toBuilder() throws -> IGPChatSendMessage.Builder {
        return try IGPChatSendMessage.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:IGPChatSendMessage) throws -> IGPChatSendMessage.Builder {
        return try IGPChatSendMessage.Builder().mergeFrom(other:prototype)
    }
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder.fromJSONToBuilder(data:data).build()
    }
    ...
    final public class Builder : GeneratedRequestMessageBuilder {
        fileprivate var builderResult:IGPChatSendMessage = IGPChatSendMessage()
        public func getMessage() -> IGPChatSendMessage {
        ...
        @discardableResult
        public override func setIgpRequest(_ value:IGPRequest!) -> IGPChatSendMessage.Builder {
            self.igpRequest = value
            return self
        }
        @discardableResult
        public func mergeIgpRequest(value:IGPRequest) throws -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func clearIgpRequest() -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
            public func setIgpMessageType(_ value:IGPRoomMessageType) -> IGPChatSendMessage.Builder {
              self.igpMessageType = value
              return self
            }
        @discardableResult
            public func clearIgpMessageType() -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func setIgpRoomId(_ value:Int64) -> IGPChatSendMessage.Builder {
            self.igpRoomId = value
            return self
        }
        @discardableResult
        public func clearIgpRoomId() -> IGPChatSendMessage.Builder{
        ...
        @discardableResult
        public func setIgpMessage(_ value:String) -> IGPChatSendMessage.Builder {
            self.igpMessage = value
            return self
        }
        @discardableResult
        public func clearIgpMessage() -> IGPChatSendMessage.Builder{
        ...
        @discardableResult
        public func setIgpAttachment(_ value:String) -> IGPChatSendMessage.Builder {
            self.igpAttachment = value
            return self
        }
        @discardableResult
        public func clearIgpAttachment() -> IGPChatSendMessage.Builder{
        ...
        @discardableResult
        public func setIgpLocation(_ value:IGPRoomMessageLocation!) -> IGPChatSendMessage.Builder {
            self.igpLocation = value
            return self
        }
        @discardableResult
        public func mergeIgpLocation(value:IGPRoomMessageLocation) throws -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func clearIgpLocation() -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func setIgpContact(_ value:IGPRoomMessageContact!) -> IGPChatSendMessage.Builder {
            self.igpContact = value
            return self
        }
        @discardableResult
        public func mergeIgpContact(value:IGPRoomMessageContact) throws -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func clearIgpContact() -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func setIgpReplyTo(_ value:Int64) -> IGPChatSendMessage.Builder {
            self.igpReplyTo = value
            return self
        }
        @discardableResult
        public func clearIgpReplyTo() -> IGPChatSendMessage.Builder{
        ...
        @discardableResult
        public func setIgpForwardFrom(_ value:IGPRoomMessageForwardFrom!) -> IGPChatSendMessage.Builder {
            self.igpForwardFrom = value
            return self
        }
        @discardableResult
        public func mergeIgpForwardFrom(value:IGPRoomMessageForwardFrom) throws -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        public func clearIgpForwardFrom() -> IGPChatSendMessage.Builder {
        ...
        @discardableResult
        override public func clear() -> IGPChatSendMessage.Builder {
            builderResult = IGPChatSendMessage()
            return self
        }
        override public func clone() throws -> IGPChatSendMessage.Builder {
            return try IGPChatSendMessage.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> IGPChatSendMessage {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> IGPChatSendMessage {
            let returnMe:IGPChatSendMessage = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:IGPChatSendMessage) throws -> IGPChatSendMessage.Builder {
            if other == IGPChatSendMessage() {
                return self
            }
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> IGPChatSendMessage.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessage.Builder {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPChatSendMessage.Builder {
            let resultDecodedBuilder = IGPChatSendMessage.Builder()
        ...
        override class public func fromJSONToBuilder(data:Data) throws -> IGPChatSendMessage.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try IGPChatSendMessage.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }

}

final public class IGPChatSendMessageResponse : GeneratedResponseMessage {
    public typealias BuilderType = IGPChatSendMessageResponse.Builder

    public static func == (lhs: IGPChatSendMessageResponse, rhs: IGPChatSendMessageResponse) -> Bool {
        if lhs === rhs {
            return true
        }
        var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    public class func getBuilder() -> IGPChatSendMessageResponse.Builder {
        return IGPChatSendMessageResponse.classBuilder() as! IGPChatSendMessageResponse.Builder
    }
    public func getBuilder() -> IGPChatSendMessageResponse.Builder {
        return classBuilder() as! IGPChatSendMessageResponse.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
        return IGPChatSendMessageResponse.Builder()
    }
    override public func classBuilder() -> ProtocolBuffersMessageBuilder {
        return IGPChatSendMessageResponse.Builder()
    }
    public func toBuilder() throws -> IGPChatSendMessageResponse.Builder {
        return try IGPChatSendMessageResponse.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:IGPChatSendMessageResponse) throws -> IGPChatSendMessageResponse.Builder {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
        guard isInitialized() else {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message")
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasIgpResponse {
    ...
    override public class func className() -> String {
        return "IGPChatSendMessageResponse"
    }
    override public func className() -> String {
        return "IGPChatSendMessageResponse"
    }
    ...
    final public class Builder : GeneratedResponseMessageBuilder {
        fileprivate var builderResult:IGPChatSendMessageResponse = IGPChatSendMessageResponse()
        public func getMessage() -> IGPChatSendMessageResponse {
            return builderResult
        }
        ...
        @discardableResult
        public func setIgpResponse(_ value:IGPResponse!) -> IGPChatSendMessageResponse.Builder {
            self.igpResponse = value
            return self
        }
        @discardableResult
        public func mergeIgpResponse(value:IGPResponse) throws -> IGPChatSendMessageResponse.Builder {
        ...
        @discardableResult
        public func clearIgpResponse() -> IGPChatSendMessageResponse.Builder {
        ...
        @discardableResult
        public func setIgpRoomId(_ value:Int64) -> IGPChatSendMessageResponse.Builder {
            self.igpRoomId = value
            return self
        }
        @discardableResult
        public func clearIgpRoomId() -> IGPChatSendMessageResponse.Builder{
            builderResult.hasIgpRoomId = false
            builderResult.igpRoomId = nil
            return self
        }
        ...
        @discardableResult
        public func setIgpRoomMessage(_ value:IGPRoomMessage!) -> IGPChatSendMessageResponse.Builder {
            self.igpRoomMessage = value
            return self
        }
        @discardableResult
        public func mergeIgpRoomMessage(value:IGPRoomMessage) throws -> IGPChatSendMessageResponse.Builder {
        ...
        @discardableResult
        public func clearIgpRoomMessage() -> IGPChatSendMessageResponse.Builder {
        ...
        @discardableResult
        override public func clear() -> IGPChatSendMessageResponse.Builder {
            builderResult = IGPChatSendMessageResponse()
            return self
        }
        override public func clone() throws -> IGPChatSendMessageResponse.Builder {
            return try IGPChatSendMessageResponse.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> IGPChatSendMessageResponse {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> IGPChatSendMessageResponse {
            let returnMe:IGPChatSendMessageResponse = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:IGPChatSendMessageResponse) throws -> IGPChatSendMessageResponse.Builder {
            if other == IGPChatSendMessageResponse() {
                return self
            }
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> IGPChatSendMessageResponse.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessageResponse.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
            while (true) {
                let protobufTag = try codedInputStream.readTag()
                switch protobufTag {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPChatSendMessageResponse.Builder {
            let resultDecodedBuilder = IGPChatSendMessageResponse.Builder()
        ...
        override class public func fromJSONToBuilder(data:Data) throws -> IGPChatSendMessageResponse.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try IGPChatSendMessageResponse.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }

}

extension IGPChatSendMessage: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<IGPChatSendMessage> {
        var mergedArray = Array<IGPChatSendMessage>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> IGPChatSendMessage? {
        return try IGPChatSendMessage.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder().mergeFrom(data: data, extensionRegistry:ChatSendMessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessage {
        return try IGPChatSendMessage.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
...
extension IGPChatSendMessage.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPChatSendMessage
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpRequest": return self.igpRequest
...
extension IGPChatSendMessageResponse: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<IGPChatSendMessageResponse> {
        var mergedArray = Array<IGPChatSendMessageResponse>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> IGPChatSendMessageResponse? {
        return try IGPChatSendMessageResponse.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(data: data, extensionRegistry:ChatSendMessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> IGPChatSendMessageResponse {
        return try IGPChatSendMessageResponse.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
    public subscript(key: String) -> Any? {
        switch key {
...
extension IGPChatSendMessageResponse.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPChatSendMessageResponse
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpResponse": return self.igpResponse
