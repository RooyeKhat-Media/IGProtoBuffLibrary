...
public struct IGPChannelCheckUsername: SwiftProtobuf.RequestMessage {
  public static let protoMessageName: String = "IGPChannelCheckUsername"
...
public struct IGPChannelCheckUsernameResponse: SwiftProtobuf.ResponseMessage {
  public static let protoMessageName: String = "IGPChannelCheckUsernameResponse"
...
extension IGPChannelCheckUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: IGPChannelCheckUsername) -> Bool {
...
extension IGPChannelCheckUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  fileprivate class _StorageClass {
    ...
    var _igpStatus: IGPChannelCheckUsernameResponse.IGPStatus = .invalid
  ...
  public func _protobuf_generated_isEqualTo(other: IGPChannelCheckUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
...
extension IGPChannelCheckUsernameResponse.IGPStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
