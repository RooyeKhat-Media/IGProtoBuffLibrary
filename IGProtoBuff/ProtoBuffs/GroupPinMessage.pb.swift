...
public struct IGPGroupPinMessage: SwiftProtobuf.RequestMessage {
...
public struct IGPGroupPinMessageResponse: SwiftProtobuf.ResponseMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension IGPGroupPinMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPGroupPinMessage"
...
extension IGPGroupPinMessageResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPGroupPinMessageResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
