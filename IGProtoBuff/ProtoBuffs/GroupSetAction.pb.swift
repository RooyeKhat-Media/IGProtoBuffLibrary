...
public struct IGPGroupSetAction: SwiftProtobuf.RequestMessage {
  public static let protoMessageName: String = "IGPGroupSetAction"
...
public struct IGPGroupSetActionResponse: SwiftProtobuf.ResponseMessage {
  public static let protoMessageName: String = "IGPGroupSetActionResponse"
...
extension IGPGroupSetAction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: IGPGroupSetAction) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._igpAction != other_storage._igpAction {return false}
        if _storage._igpActionID != other_storage._igpActionID {return false}
        return true
      }
...
extension IGPGroupSetActionResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func _protobuf_generated_isEqualTo(other: IGPGroupSetActionResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
