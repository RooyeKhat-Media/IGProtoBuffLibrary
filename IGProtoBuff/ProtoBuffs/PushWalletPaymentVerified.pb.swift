...
public struct IGPPushWalletPaymentVerifiedResponse: SwiftProtobuf.ResponseMessage {
...
extension IGPPushWalletPaymentVerifiedResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPPushWalletPaymentVerifiedResponse"
  ...
  public func _protobuf_generated_isEqualTo(other: IGPPushWalletPaymentVerifiedResponse) -> Bool {
