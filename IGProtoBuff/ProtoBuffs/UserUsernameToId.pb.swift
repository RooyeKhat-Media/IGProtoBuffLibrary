...
public struct IGPUserUsernameToId: SwiftProtobuf.RequestMessage {
...
public struct IGPUserUsernameToIdResponse: SwiftProtobuf.ResponseMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension IGPUserUsernameToId: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPUserUsernameToId"
  ...
  public func _protobuf_generated_isEqualTo(other: IGPUserUsernameToId) -> Bool {
...
extension IGPUserUsernameToIdResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPUserUsernameToIdResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func _protobuf_generated_isEqualTo(other: IGPUserUsernameToIdResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
