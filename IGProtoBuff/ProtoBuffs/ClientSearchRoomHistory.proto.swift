...
final public class IGPClientSearchRoomHistory : GeneratedMessage {
    public typealias BuilderType = IGPClientSearchRoomHistory.Builder
    ...
    public static func == (lhs: IGPClientSearchRoomHistory, rhs: IGPClientSearchRoomHistory) -> Bool {
        ...
        fieldCheck = fieldCheck && (lhs.hasIgpOffsetMessageId == rhs.hasIgpOffsetMessageId) && (!lhs.hasIgpOffsetMessageId || lhs.igpOffsetMessageId == rhs.igpOffsetMessageId)
    ...
    //iGap Properties declaration end
        ...
        public enum IGPFilter:Int32, GeneratedEnum {
            case image = 0
            case video = 1
            case audio = 2
            case voice = 3
            ...
            public static func fromString(_ str:String) throws -> IGPClientSearchRoomHistory.IGPFilter {
                switch str {
                case "IMAGE":    return .image
                case "VIDEO":    return .video
                case "AUDIO":    return .audio
    ...
    public fileprivate(set) var igpOffsetMessageId:Int64! = nil
    public fileprivate(set) var hasIgpOffsetMessageId:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        ...
        if hasIgpOffsetMessageId {
            try codedOutputStream.writeInt64(fieldNumber: 5, value:igpOffsetMessageId)
        }
    ...
    override public func serializedSize() -> Int32 {
        ...
        if hasIgpOffsetMessageId {
            serialize_size += igpOffsetMessageId.computeInt64Size(fieldNumber: 5)
        }
    ...
    override public func encode() throws -> Dictionary<String,Any> {
        ...
        if hasIgpOffsetMessageId {
            jsonMap["IGPOffsetMessageId"] = "\(igpOffsetMessageId!)"
        }
        return jsonMap
    }
    ...
    override public func getDescription(indent:String) throws -> String {
        ...
        if hasIgpOffsetMessageId {
            output += "\(indent) igpOffsetMessageId: \(igpOffsetMessageId) \n"
        }
    ...
    override public var hashValue:Int {
        get {
            ...
            if hasIgpOffsetMessageId {
                hashCode = (hashCode &* 31) &+ igpOffsetMessageId.hashValue
            }
    ...
    final public class Builder : GeneratedRequestMessageBuilder {
        ...
        public var igpOffsetMessageId:Int64 {
            get {
                return builderResult.igpOffsetMessageId
            }
            set (value) {
                builderResult.hasIgpOffsetMessageId = true
                builderResult.igpOffsetMessageId = value
            }
        }
        public var hasIgpOffsetMessageId:Bool {
            get {
                return builderResult.hasIgpOffsetMessageId
            }
        }
        @discardableResult
        public func setIgpOffsetMessageId(_ value:Int64) -> IGPClientSearchRoomHistory.Builder {
            self.igpOffsetMessageId = value
            return self
        }
        @discardableResult
        public func clearIgpOffsetMessageId() -> IGPClientSearchRoomHistory.Builder{
            builderResult.hasIgpOffsetMessageId = false
            builderResult.igpOffsetMessageId = nil
            return self
        }
        ...
        public func mergeFrom(other:IGPClientSearchRoomHistory) throws -> IGPClientSearchRoomHistory.Builder {
            ...
            if other.hasIgpOffsetMessageId {
                igpOffsetMessageId = other.igpOffsetMessageId
            }
        ...
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> IGPClientSearchRoomHistory.Builder {
            ...
            while (true) {
                ...
                case 40:
                    igpOffsetMessageId = try codedInputStream.readInt64()
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPClientSearchRoomHistory.Builder {
            ...
            if let jsonValueIgpFilter = jsonMap["IGPFilter"] as? String {
                resultDecodedBuilder.igpFilter = try IGPClientSearchRoomHistory.IGPFilter.fromString(jsonValueIgpFilter)
            }
            if let jsonValueIgpOffsetMessageId = jsonMap["IGPOffsetMessageId"] as? String {
                resultDecodedBuilder.igpOffsetMessageId = Int64(jsonValueIgpOffsetMessageId)!
            } else if let jsonValueIgpOffsetMessageId = jsonMap["IGPOffsetMessageId"] as? Int {
                resultDecodedBuilder.igpOffsetMessageId = Int64(jsonValueIgpOffsetMessageId)
            }
...
final public class IGPClientSearchRoomHistoryResponse : GeneratedResponseMessage {
    public typealias BuilderType = IGPClientSearchRoomHistoryResponse.Builder
    ...
    public fileprivate(set) var igpTotalCount:Int32! = nil
    public fileprivate(set) var hasIgpTotalCount:Bool = false

    public fileprivate(set) var igpNotDeletedCount:Int32! = nil
    ...
    final public class Builder : GeneratedResponseMessageBuilder {
        ...
        public func clearIgpTotalCount() -> IGPClientSearchRoomHistoryResponse.Builder{
            ...
            builderResult.igpTotalCount = nil
            return self
        }
        ...
        public func clearIgpNotDeletedCount() -> IGPClientSearchRoomHistoryResponse.Builder{
            ...
            builderResult.igpNotDeletedCount = nil
            return self
        }
...
extension IGPClientSearchRoomHistory: GeneratedMessageProtocol {
    ...
    public subscript(key: String) -> Any? {
        ...
        case "igpOffsetMessageId": return self.igpOffsetMessageId
        default: return nil
        }
    }
}
extension IGPClientSearchRoomHistory.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPClientSearchRoomHistory
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpRequest": return self.igpRequest
        ...
        set (newSubscriptValue) { 
            ...
            case "igpOffsetMessageId":
                guard let newSubscriptValue = newSubscriptValue as? Int64 else {
                    return
                }
                self.igpOffsetMessageId = newSubscriptValue
            default: return
            }
        }
    }
...
extension IGPClientSearchRoomHistoryResponse.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPClientSearchRoomHistoryResponse
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpResponse": return self.igpResponse
