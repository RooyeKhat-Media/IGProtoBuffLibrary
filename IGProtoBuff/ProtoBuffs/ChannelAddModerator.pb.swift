...
public struct IGPChannelAddModerator: SwiftProtobuf.RequestMessage {
  public static let protoMessageName: String = "IGPChannelAddModerator"
...
public struct IGPChannelAddModeratorResponse: SwiftProtobuf.ResponseMessage {
  public static let protoMessageName: String = "IGPChannelAddModeratorResponse"
...
extension IGPChannelAddModerator: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: IGPChannelAddModerator) -> Bool {
...
extension IGPChannelAddModeratorResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func _protobuf_generated_isEqualTo(other: IGPChannelAddModeratorResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
