...
public enum IGPGender:Int32, GeneratedEnum {
    case unknown = 0
    case male = 1
    case female = 2
    ...
    public static func fromString(_ str:String) throws -> IGPGender {
        switch str {
        case "UNKNOWN":    return .unknown
        case "MALE":    return .male
        case "FEMALE":    return .female
...
public enum IGPDevice:Int32, GeneratedEnum {
    ...
    public static func fromString(_ str:String) throws -> IGPDevice {
        switch str {
...
public enum IGPPlatform:Int32, GeneratedEnum {
    ...
    public static func fromString(_ str:String) throws -> IGPPlatform {
        switch str {
...
public enum IGPLanguage:Int32, GeneratedEnum {
    case enUs = 0
    case faIr = 1
    public func toString() -> String {
        switch self {
    ...
    public static func fromString(_ str:String) throws -> IGPLanguage {
        switch str {
...
public enum IGPRoomMessageType:Int32, GeneratedEnum {
    case text = 0
    case image = 1
    case imageText = 2
    case video = 3
    ...
    public static func fromString(_ str:String) throws -> IGPRoomMessageType {
        switch str {
        case "TEXT":    return .text
        case "IMAGE":    return .image
...
public enum IGPRoomMessageStatus:Int32, GeneratedEnum {
    case failed = 0
    case sending = 1
    case sent = 2
    case delivered = 3
    ...
    public static func fromString(_ str:String) throws -> IGPRoomMessageStatus {
        switch str {
        case "FAILED":    return .failed
        case "SENDING":    return .sending
        case "SENT":    return .sent
...
public enum IGPRoomMessageReaction:Int32, GeneratedEnum {
    case thumbsUp = 0
    case thumbsDown = 1
    public func toString() -> String {
        switch self {
    ...
    public static func fromString(_ str:String) throws -> IGPRoomMessageReaction {
        switch str {
...
public enum IGPClientAction:Int32, GeneratedEnum {
    case cancel = 0
    case typing = 1
    case sendingImage = 2
    ...
    public static func fromString(_ str:String) throws -> IGPClientAction {
        switch str {
        case "CANCEL":    return .cancel
        case "TYPING":    return .typing
...
public enum IGPPrivacyType:Int32, GeneratedEnum {
    case userStatus = 0
    case avatar = 1
    case groupInvite = 2
    ...
    public static func fromString(_ str:String) throws -> IGPPrivacyType {
        switch str {
...
public enum IGPPrivacyLevel:Int32, GeneratedEnum {
    case allowAll = 0
    case denyAll = 1
    ...
    public static func fromString(_ str:String) throws -> IGPPrivacyLevel {
        switch str {
...
final public class IGPRoomMessageLocation : GeneratedMessage {
    public typealias BuilderType = IGPRoomMessageLocation.Builder
...
final public class IGPRoomMessageLog : GeneratedMessage {
    public typealias BuilderType = IGPRoomMessageLog.Builder
    ...
    final public class IGPTargetUser : GeneratedMessage {
        public typealias BuilderType = IGPRoomMessageLog.IGPTargetUser.Builder
    ...
    //iGap Properties declaration end
        ...
        public enum IGPType:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPRoomMessageLog.IGPType {
                switch str {
        ...
        public enum IGPExtraType:Int32, GeneratedEnum {
            case noExtra = 0
            case targetUser = 1
            public func toString() -> String {
                switch self {
            ...
            public static func fromString(_ str:String) throws -> IGPRoomMessageLog.IGPExtraType {
                switch str {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPRoomMessageLog.Builder {
            ...
            if let jsonValueIgpType = jsonMap["IGPType"] as? String {
                resultDecodedBuilder.igpType = try IGPRoomMessageLog.IGPType.fromString(jsonValueIgpType)
            }
            if let jsonValueIgpExtraType = jsonMap["IGPExtraType"] as? String {
                resultDecodedBuilder.igpExtraType = try IGPRoomMessageLog.IGPExtraType.fromString(jsonValueIgpExtraType)
            }
...
final public class IGPRoomMessageContact : GeneratedMessage {
    public typealias BuilderType = IGPRoomMessageContact.Builder
...
final public class IGPRoomMessageForwardFrom : GeneratedMessage {
    public typealias BuilderType = IGPRoomMessageForwardFrom.Builder
...
final public class IGPRegisteredUser : GeneratedMessage {
    public typealias BuilderType = IGPRegisteredUser.Builder
    ...
    //iGap Properties declaration end
        ...
        public enum IGPStatus:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPRegisteredUser.IGPStatus {
                switch str {
    ...
    public fileprivate(set) var igpDisplayName:String! = nil
    ...
    public fileprivate(set) var igpColor:String! = nil
    ...
    public fileprivate(set) var igpLastSeen:Int32! = nil
    public fileprivate(set) var hasIgpLastSeen:Bool = false

    public fileprivate(set) var igpAvatarCount:Int32! = nil
    ...
    public fileprivate(set) var igpMutual:Bool! = nil
    public fileprivate(set) var hasIgpMutual:Bool = false

    public fileprivate(set) var igpDeleted:Bool! = nil
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public func clearIgpDisplayName() -> IGPRegisteredUser.Builder{
            ...
            builderResult.igpDisplayName = nil
            return self
        }
        ...
        public func clearIgpAvatarCount() -> IGPRegisteredUser.Builder{
            ...
            builderResult.igpAvatarCount = nil
            return self
        }
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPRegisteredUser.Builder {
            ...
            if let jsonValueIgpStatus = jsonMap["IGPStatus"] as? String {
                resultDecodedBuilder.igpStatus = try IGPRegisteredUser.IGPStatus.fromString(jsonValueIgpStatus)
            }
...
final public class IGPAvatar : GeneratedMessage {
    public typealias BuilderType = IGPAvatar.Builder
...
final public class IGPRoomMessage : GeneratedMessage {
    public typealias BuilderType = IGPRoomMessage.Builder
    ...
    final public class IGPAuthor : GeneratedMessage {
        public typealias BuilderType = IGPRoomMessage.IGPAuthor.Builder
        ...
        final public class IGPUser : GeneratedMessage {
            public typealias BuilderType = IGPRoomMessage.IGPAuthor.IGPUser.Builder
        ...
        final public class IGPRoom : GeneratedMessage {
            public typealias BuilderType = IGPRoomMessage.IGPAuthor.IGPRoom.Builder
        ...
        public fileprivate(set) var igpHash:String! = nil
    ...
    final public class IGPChannelExtra : GeneratedMessage {
        public typealias BuilderType = IGPRoomMessage.IGPChannelExtra.Builder
        ...
        public fileprivate(set) var igpSignature:String! = nil
        public fileprivate(set) var hasIgpSignature:Bool = false

        public fileprivate(set) var igpViewsLabel:String! = nil
        public fileprivate(set) var hasIgpViewsLabel:Bool = false

        public fileprivate(set) var igpThumbsUpLabel:String! = nil
        public fileprivate(set) var hasIgpThumbsUpLabel:Bool = false

        public fileprivate(set) var igpThumbsDownLabel:String! = nil
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            public func clearIgpViewsLabel() -> IGPRoomMessage.IGPChannelExtra.Builder{
                ...
                builderResult.igpViewsLabel = nil
                return self
            }
            ...
            public func clearIgpThumbsUpLabel() -> IGPRoomMessage.IGPChannelExtra.Builder{
                ...
                builderResult.igpThumbsUpLabel = nil
                return self
            }
            ...
            public func clearIgpThumbsDownLabel() -> IGPRoomMessage.IGPChannelExtra.Builder{
                ...
                builderResult.igpThumbsDownLabel = nil
                return self
            }
            override public var internalGetResult:GeneratedMessage {
                get {
    ...
    //iGap Properties declaration end
        ...
        public enum IGPExtraType:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPRoomMessage.IGPExtraType {
                switch str {
                case "NO_EXTRA":    return .noExtra
    ...
    public fileprivate(set) var igpEdited:Bool! = nil
    ...
    public fileprivate(set) var igpUpdateTime:Int32! = nil
    ...
    public fileprivate(set) var igpPreviousMessageId:Int64! = nil
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public func clearIgpUpdateTime() -> IGPRoomMessage.Builder{
            ...
            builderResult.igpUpdateTime = nil
            return self
        }
        public var igpDeleted:Bool {
            get {
        ...
        public func clearIgpPreviousMessageId() -> IGPRoomMessage.Builder{
            ...
            builderResult.igpPreviousMessageId = nil
            return self
        }
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPRoomMessage.Builder {
            ...
            if let jsonValueIgpExtraType = jsonMap["IGPExtraType"] as? String {
                resultDecodedBuilder.igpExtraType = try IGPRoomMessage.IGPExtraType.fromString(jsonValueIgpExtraType)
            }
...
final public class IGPRoomDraft : GeneratedMessage {
    public typealias BuilderType = IGPRoomDraft.Builder
...
final public class IGPRoom : GeneratedMessage {
    public typealias BuilderType = IGPRoom.Builder
    ...
    //iGap Properties declaration end
        ...
        public enum IGPType:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPRoom.IGPType {
                switch str {
                case "CHAT":    return .chat
                case "GROUP":    return .group
                case "CHANNEL":    return .channel
    ...
    public fileprivate(set) var hasIgpType:Bool = false
    public fileprivate(set) var igpTitle:String! = nil
    ...
    public fileprivate(set) var igpUnreadCount:Int32! = nil
    ...
    public fileprivate(set) var igpReadOnly:Bool! = nil
    public fileprivate(set) var hasIgpReadOnly:Bool = false

    public fileprivate(set) var igpIsParticipant:Bool! = nil
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public func clearIgpUnreadCount() -> IGPRoom.Builder{
            ...
            builderResult.igpUnreadCount = nil
            return self
        }
        ...
        public func clearIgpIsParticipant() -> IGPRoom.Builder{
            ...
            builderResult.igpIsParticipant = nil
            return self
        }
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPRoom.Builder {
            ...
            if let jsonValueIgpType = jsonMap["IGPType"] as? String {
                resultDecodedBuilder.igpType = try IGPRoom.IGPType.fromString(jsonValueIgpType)
            }
...
final public class IGPChatRoom : GeneratedMessage {
    public typealias BuilderType = IGPChatRoom.Builder
...
final public class IGPGroupRoom : GeneratedMessage {
    public typealias BuilderType = IGPGroupRoom.Builder
    ...
    final public class IGPPrivateExtra : GeneratedMessage {
        public typealias BuilderType = IGPGroupRoom.IGPPrivateExtra.Builder
    ...
    final public class IGPPublicExtra : GeneratedMessage {
        public typealias BuilderType = IGPGroupRoom.IGPPublicExtra.Builder
    ...
    //iGap Properties declaration end
        ...
        public enum IGPType:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPGroupRoom.IGPType {
                switch str {
        ...
        public enum IGPRole:Int32, GeneratedEnum {
            case member = 0
            case moderator = 1
            case admin = 2
            case owner = 3
            ...
            public static func fromString(_ str:String) throws -> IGPGroupRoom.IGPRole {
                switch str {
                case "MEMBER":    return .member
                case "MODERATOR":    return .moderator
                case "ADMIN":    return .admin
    ...
    public fileprivate(set) var igpParticipantsCount:Int32! = nil
    public fileprivate(set) var hasIgpParticipantsCount:Bool = false

    public fileprivate(set) var igpParticipantsCountLabel:String! = nil
    public fileprivate(set) var hasIgpParticipantsCountLabel:Bool = false

    public fileprivate(set) var igpParticipantsCountLimit:Int32! = nil
    public fileprivate(set) var hasIgpParticipantsCountLimit:Bool = false

    public fileprivate(set) var igpParticipantsCountLimitLabel:String! = nil
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public func clearIgpParticipantsCount() -> IGPGroupRoom.Builder{
            ...
            builderResult.igpParticipantsCount = nil
            return self
        }
        ...
        public func clearIgpParticipantsCountLabel() -> IGPGroupRoom.Builder{
            ...
            builderResult.igpParticipantsCountLabel = nil
            return self
        }
        ...
        public func clearIgpParticipantsCountLimit() -> IGPGroupRoom.Builder{
            ...
            builderResult.igpParticipantsCountLimit = nil
            return self
        }
        ...
        public func clearIgpParticipantsCountLimitLabel() -> IGPGroupRoom.Builder{
            ...
            builderResult.igpParticipantsCountLimitLabel = nil
            return self
        }
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPGroupRoom.Builder {
            ...
            if let jsonValueIgpType = jsonMap["IGPType"] as? String {
                resultDecodedBuilder.igpType = try IGPGroupRoom.IGPType.fromString(jsonValueIgpType)
            }
...
final public class IGPChannelRoom : GeneratedMessage {
    public typealias BuilderType = IGPChannelRoom.Builder
    ...
    final public class IGPPrivateExtra : GeneratedMessage {
        public typealias BuilderType = IGPChannelRoom.IGPPrivateExtra.Builder
    ...
    final public class IGPPublicExtra : GeneratedMessage {
        public typealias BuilderType = IGPChannelRoom.IGPPublicExtra.Builder
    ...
    //iGap Properties declaration end
        ...
        public enum IGPType:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPChannelRoom.IGPType {
                switch str {
                case "PRIVATE_ROOM":    return .privateRoom
                case "PUBLIC_ROOM":    return .publicRoom
                default: throw ProtocolBuffersError.invalidProtocolBuffer("Conversion failed.")
        ...
        public enum IGPRole:Int32, GeneratedEnum {
            ...
            public static func fromString(_ str:String) throws -> IGPChannelRoom.IGPRole {
                switch str {
                case "MEMBER":    return .member
                case "MODERATOR":    return .moderator
                case "ADMIN":    return .admin
    ...
    public fileprivate(set) var igpSeenId:Int64! = nil
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPChannelRoom.Builder {
            ...
            if let jsonValueIgpType = jsonMap["IGPType"] as? String {
                resultDecodedBuilder.igpType = try IGPChannelRoom.IGPType.fromString(jsonValueIgpType)
            }
            if let jsonValueIgpRole = jsonMap["IGPRole"] as? String {
...
final public class IGPThumbnail : GeneratedMessage {
    public typealias BuilderType = IGPThumbnail.Builder
    ...
    public fileprivate(set) var igpWidth:Int32! = nil
    public fileprivate(set) var hasIgpWidth:Bool = false

    public fileprivate(set) var igpHeight:Int32! = nil
...
final public class IGPFile : GeneratedMessage {
    public typealias BuilderType = IGPFile.Builder
    ...
    public fileprivate(set) var igpDuration:Double! = nil
...
final public class IGPWallpaper : GeneratedMessage {
    public typealias BuilderType = IGPWallpaper.Builder
...
final public class IGPPagination : GeneratedMessage {
    public typealias BuilderType = IGPPagination.Builder
    ...
    public fileprivate(set) var igpOffset:Int32! = nil
...
extension IGPRoomMessageLocation.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessageLocation
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpLat": return self.igpLat
...
extension IGPRoomMessageLog.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessageLog
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpType": return self.igpType
...
extension IGPRoomMessageLog.IGPTargetUser.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessageLog.IGPTargetUser
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpId": return self.igpId
...
extension IGPRoomMessageContact.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessageContact
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpFirstName": return self.igpFirstName
...
extension IGPRoomMessageForwardFrom.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessageForwardFrom
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpRoomId": return self.igpRoomId
...
extension IGPRegisteredUser.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRegisteredUser
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpId": return self.igpId
...
extension IGPAvatar.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPAvatar
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpId": return self.igpId
...
extension IGPRoomMessage.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessage
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpMessageId": return self.igpMessageId
...
extension IGPRoomMessage.IGPAuthor.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessage.IGPAuthor
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpHash": return self.igpHash
...
extension IGPRoomMessage.IGPAuthor.IGPUser.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessage.IGPAuthor.IGPUser
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpUserId": return self.igpUserId
...
extension IGPRoomMessage.IGPAuthor.IGPRoom.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessage.IGPAuthor.IGPRoom
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpRoomId": return self.igpRoomId
...
extension IGPRoomMessage.IGPChannelExtra.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomMessage.IGPChannelExtra
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpSignature": return self.igpSignature
...
extension IGPRoomDraft.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoomDraft
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpMessage": return self.igpMessage
...
extension IGPRoom.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPRoom
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpId": return self.igpId
...
extension IGPChatRoom.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPChatRoom
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpPeer": return self.igpPeer
...
extension IGPGroupRoom.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPGroupRoom
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpType": return self.igpType
...
extension IGPGroupRoom.IGPPrivateExtra.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPGroupRoom.IGPPrivateExtra
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpInviteLink": return self.igpInviteLink
...
extension IGPGroupRoom.IGPPublicExtra.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPGroupRoom.IGPPublicExtra
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpUsername": return self.igpUsername
...
extension IGPChannelRoom.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPChannelRoom
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpType": return self.igpType
...
extension IGPChannelRoom.IGPPrivateExtra.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPChannelRoom.IGPPrivateExtra
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpInviteLink": return self.igpInviteLink
...
extension IGPChannelRoom.IGPPublicExtra.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPChannelRoom.IGPPublicExtra
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpUsername": return self.igpUsername
...
extension IGPThumbnail.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPThumbnail
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpSize": return self.igpSize
...
extension IGPFile.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPFile
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpToken": return self.igpToken
...
extension IGPWallpaper.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPWallpaper
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpFile": return self.igpFile
...
extension IGPPagination.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = IGPPagination
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "igpOffset": return self.igpOffset
