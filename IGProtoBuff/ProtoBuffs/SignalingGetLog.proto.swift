    ...
    final public class IGPSignalingLog : GeneratedMessage {
        ...
        //iGap Properties declaration end
            ...
            public enum IGPStatus:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
                ...
                public static func fromString(str:String) throws -> IGPSignalingGetLogResponse.IGPSignalingLog.IGPStatus {
                    switch str {
                    case "MISSED":    return .missed
                    case "CANCELED":    return .canceled
                    case "INCOMING":    return .incoming
        ...
        public fileprivate(set) var igpOfferTime:Int32 = Int32(0)
        public fileprivate(set) var hasIgpOfferTime:Bool = false

        public fileprivate(set) var igpDuration:Int32 = Int32(0)
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            public func clearIgpOfferTime() -> IGPSignalingGetLogResponse.IGPSignalingLog.Builder{
                ...
                builderResult.igpOfferTime = Int32(0)
                return self
            }
            ...
            public func clearIgpDuration() -> IGPSignalingGetLogResponse.IGPSignalingLog.Builder{
                ...
                builderResult.igpDuration = Int32(0)
                return self
            }
            override public var internalGetResult:GeneratedMessage {
                get {
            ...
            class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> IGPSignalingGetLogResponse.IGPSignalingLog.Builder {
                ...
                if let jsonValueIgpStatus = jsonMap["IGPStatus"] as? String {
                    resultDecodedBuilder.igpStatus = try IGPSignalingGetLogResponse.IGPSignalingLog.IGPStatus.fromString(str: jsonValueIgpStatus)
                }
