...
public struct IGPUserTwoStepVerificationVerifyPassword: SwiftProtobuf.RequestMessage {
  public static let protoMessageName: String = "IGPUserTwoStepVerificationVerifyPassword"
...
public struct IGPUserTwoStepVerificationVerifyPasswordResponse: SwiftProtobuf.ResponseMessage {
  public static let protoMessageName: String = "IGPUserTwoStepVerificationVerifyPasswordResponse"
...
extension IGPUserTwoStepVerificationVerifyPassword: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: IGPUserTwoStepVerificationVerifyPassword) -> Bool {
...
extension IGPUserTwoStepVerificationVerifyPasswordResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func _protobuf_generated_isEqualTo(other: IGPUserTwoStepVerificationVerifyPasswordResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
