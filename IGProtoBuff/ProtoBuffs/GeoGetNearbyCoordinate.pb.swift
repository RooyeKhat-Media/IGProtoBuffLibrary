...
public struct IGPGeoGetNearbyCoordinate: SwiftProtobuf.RequestMessage {
  public static let protoMessageName: String = "IGPGeoGetNearbyCoordinate"
...
public struct IGPGeoGetNearbyCoordinateResponse: SwiftProtobuf.ResponseMessage {
  public static let protoMessageName: String = "IGPGeoGetNearbyCoordinateResponse"
  ...
  public struct IGPResult: SwiftProtobuf.Message {
    public static let protoMessageName: String = IGPGeoGetNearbyCoordinateResponse.protoMessageName + ".IGPResult"
