...
public struct IGPGroupAddMember: SwiftProtobuf.RequestMessage {
  ...
  public var igpMember: IGPGroupAddMember.IGPMember {
    get {return _storage._igpMember ?? IGPGroupAddMember.IGPMember()}
  ...
  public struct IGPMember: SwiftProtobuf.Message {
    ...
    public var igpStartMessageID: Int64 = 0
...
public struct IGPGroupAddMemberResponse: SwiftProtobuf.ResponseMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension IGPGroupAddMember: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPGroupAddMember"
  ...
  fileprivate class _StorageClass {
    ...
    var _igpMember: IGPGroupAddMember.IGPMember? = nil
...
extension IGPGroupAddMember.IGPMember: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = IGPGroupAddMember.protoMessageName + ".IGPMember"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "IGP_user_id"),
    2: .standard(proto: "IGP_start_message_id"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularInt64Field(value: &self.igpStartMessageID)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.igpStartMessageID != 0 {
      try visitor.visitSingularInt64Field(value: self.igpStartMessageID, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension IGPGroupAddMemberResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "IGPGroupAddMemberResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
