...
public struct IGPGroupUpdateUsername: SwiftProtobuf.RequestMessage {
  public static let protoMessageName: String = "IGPGroupUpdateUsername"
...
public struct IGPGroupUpdateUsernameResponse: SwiftProtobuf.ResponseMessage {
  public static let protoMessageName: String = "IGPGroupUpdateUsernameResponse"
...
extension IGPGroupUpdateUsername: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: IGPGroupUpdateUsername) -> Bool {
...
extension IGPGroupUpdateUsernameResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func _protobuf_generated_isEqualTo(other: IGPGroupUpdateUsernameResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
